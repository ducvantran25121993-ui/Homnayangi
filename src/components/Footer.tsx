      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500">
                Gợi ý ẩm thực 3 miền, vòng quay may mắn & liên kết đặt món nhận hoa hồng
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-stone-600">
            ...
            >
              Chính Sách Tiếp Thị Liên Kết (Affiliate)
            </button>
            <span>•</span>
            <span className="text-stone-400">
              Đối tác chính thức: ShopeeFood, GrabFood, BeFood
            </span>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-stone-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-stone-400">
          <p>
            © {new Date().getFullYear()} Hôm Nay Ăn Gì. Nền tảng hoạt động theo mô hình tiếp thị liên kết (Affiliate Marketing).
          </p>
