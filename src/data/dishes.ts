...
export const WHEEL_PRESETS: WheelPreset[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Lẩu Gà Tiềm Ớt Hiểm',
      'Nướng Ngói Bơ Tỏi Xì Xèo',
      'Sườn Nướng BBQ Sốt Khói',
      ...
      'Ốc Hương Xào Bơ Tỏi Trứng Muối',
      'Gà Nướng Cơm Lam Tây Bắc',
      'Gà Rán Giòn Cay Sốt Hàn Quốc',
      'Chân Gà Nướng Mật Ong',
      'Dồi Sụn Nướng Than Hoa',
      'Chim Cút Quay Mật Ong',
      'Heo Quay Da Giòn Bánh Hỏi',
      'Nem Nướng Nha Trang Cuốn Bánh Tráng',
      'Bánh Xèo Nam Bộ Tôm Thịt',
      'Bánh Mì Chảo Xíu Mại Trứng Lòng Đào',
      'Bò Kho Bánh Mỳ',
      'Dimsum Há Cảo Tôm Xíu Mại',
      'Pizza Hải Sản Phô Mai',
      'Pizza Bò Băm Phô Mai Đút Lò',
      'Mỳ Ý Sốt Bò Băm Bolognese',
      'Cháo Ếch Singapore Niêu Đất',
      'Cháo Sườn Sụn Quẩy Giòn',
      'Bột Chiên Giòn Đôi Trứng',
    ],
  },
];
