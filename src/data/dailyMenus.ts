...
export const DAILY_DAY_MENUS: DailyMealOption[] = [
  ...
  // ==========================================
  {
    id: 't2',
    dayName: 'Thứ Hai',
    title: 'Mâm Cơm Thanh Ngọt - Dễ Nấu Cho Đầu Tuần Bận Rộn',
    tagline: 'Mâm cơm 3 món ấm cúng với thịt ba chỉ kho tiêu đậm vị, đĩa rau muống xào xanh giòn và tô canh chua cá lóc giải nhiệt.',
...
export const THEMATIC_MENUS = [
  {
    ...
    items: [
      { role: 'Món Mặn', name: 'Thịt Ba Chỉ Kho Tàu Trứng Cút Nước Dừa', dishId: 'thit-kho-tau' },
      { role: 'Món Xào', name: 'Rau Muống Xào Tỏi Lửa Lớn Giòn Xanh', dishId: 'rau-muong-xao-toi' },
      { role: 'Món Canh', name: 'Canh Cua Mồng Tơi Mướp Hương Cà Pháo', dishId: 'canh-cua-dong' },
      { role: 'Tráng Miệng', name: 'Dưa Hấu Đỏ Hoặc Trà Sen Vàng Thơm Mát', dishId: 'tra-dao-cam-sa' },
    ],
  },
  {
    ...
    items: [
      { role: 'Món Chính', name: 'Sườn Heo Rim Mặn Ngọt Vàng Óng', dishId: 'com-tam-suon-bi-cha' },
      { role: 'Ăn Kèm', name: 'Trứng Chiên Cuộn Hành Cà Chua', dishId: 'thit-kho-tau' },
      { role: 'Món Canh', name: 'Canh Cải Ngọt Nấu Thịt Nạc Băm', dishId: 'canh-chua-ca-loc' },
      { role: 'Thức Uống', name: 'Nước Ép Cam Táo Mát Lành', dishId: 'tra-dao-cam-sa' },
    ],
  },
  {
    ...
    items: [
      { role: 'Món Chính', name: 'Cá Diêu Hồng Hấp Gừng Hành Xì Dầu', dishId: 'com-ca-kho-to' },
      { role: 'Món Rau', name: 'Rau Củ Quả Luộc Ngũ Sắc Chấm Kho Quẹt', dishId: 'rau-muong-xao-toi' },
      { role: 'Món Canh', name: 'Canh Bí Đao Nấu Tôm Tươi Hạt Sen', dishId: 'canh-cua-dong' },
      { role: 'Tráng Miệng', name: 'Bưởi Da Xanh & Nước Ép Cần Tây', dishId: 'tra-dao-cam-sa' },
    ],
  },
  {
    ...
    items: [
      { role: 'Món Khai Vị', name: 'Gỏi Cuốn Tôm Thịt Bánh Tráng Dẻo', dishId: 'goi-cuon-tom-thit' },
      { role: 'Món Mặn', name: 'Gà Đồi Hấp Muối Hột Lá Chanh', dishId: 'com-ga-xoi-mo' },
      { role: 'Món Canh', name: 'Canh Măng Tươi Nấu Sườn Heo Hành Hoa', dishId: 'canh-chua-ca-loc' },
      { role: 'Tráng Miệng', name: 'Chè Hạt Sen Long Nhãn Thanh Mát', dishId: 'tra-dao-cam-sa' },
    ],
  },
];
